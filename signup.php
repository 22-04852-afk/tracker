...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $confirmPassword) {
        ...
        $result = registerUser($conn, $fullName, $username, $password);
...
<head>
    ...
    <title>Sign Up - OJT Tracker</title>
    ...
    <style>
        ...
        .hero-line.small { width: 68%; }
        .hero-line.medium { width: 82%; animation-delay: 0.3s; }
        .hero-line.large { width: 92%; animation-delay: 0.6s; }
...
<body>
    <div class="auth-shell">
        <section class="hero-panel">
            <div>
                <div class="hero-kicker"><i class="fa-solid fa-user-plus" aria-hidden="true"></i> Create Account</div>
                <h1>Join the<br><span>protected workspace.</span></h1>
                <p>Create your account once, then sign in every time you open the app. Logout always sends you back through login.</p>
            </div>
            <div>
                ...
                <div class="hero-footer"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i> Secure sign up and login</div>
            </div>
        </section>

        <section class="form-panel">
            <h2>Sign Up</h2>
            <p>Create your account to start using the tracker.</p>
            ...
            <form method="POST" autocomplete="off">
                ...
                <div class="field password-field">
                    ...
                    <div class="password-input-wrap">
                        ...
                        <button type="button" class="password-toggle" aria-label="Show password" data-target="confirm_password">
                            <i class="fa-regular fa-eye"></i>
                        </button>
                    </div>
                </div>
